...
describe('createMessage', () => {
  test('调用方法应该创建对应的 Message 组件', async () => {
    const instance = createMessage({ message: 'hello msg', duration: 0 })
    await rAF()
  ...
  test('多次调用应该创建多个实例', async () => {
    createMessage({ message: 'hello msg', duration: 0 })
    createMessage({ message: 'hello msg2', duration: 0 })
    await rAF()
  ...
  test('创建多个实例应该设置正确的 offset', async () => {
    createMessage({ message: 'hello msg', duration: 0, offset: 100 })
    createMessage({ message: 'hello msg2', duration: 0, offset: 50 })
    await rAF()
